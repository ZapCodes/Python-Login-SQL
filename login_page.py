...
class login_page:
    def __init__(self, root):
        ...
        self.frame1.place(x=1280, y=800, width=1280, relheight = 800)



        #=============Entry Field & Buttons============

        self.frame2 = Frame(self.window, bg = "gray")
        self.frame2.place(x=0,y=0,relwidth=900, relheight=900)

        self.frame3 = Frame(self.frame2, bg="white")
        self.frame3.place(x=420,y=50,width=400,height=400)
